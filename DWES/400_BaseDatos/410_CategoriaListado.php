    ...
    <tr>
        ...
        // Usaremos el ciclo para mostrar resultados
            foreach($results as $result) {
                ...
                echo "<td><a href=410_CategoriaEliminar.php?id=".$result -> id."&nombre=".$result -> nombre." style='color: red'>X</a></td>
                </tr>";
            }
        }
        //OTRA FORMA
...
<br><br>
<a href='410_CategoriaCrear.php'>Crear nueva Categoría</a>
</body>
</html>